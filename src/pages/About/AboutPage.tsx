    ...
    <div className="about-page">
      <div className="about-content">
        ...
        <div className="about-text">
          ...
          <p>
            Sejam muito bem-vindos! Sou médica formada pela Universidade Federal de Minas Gerais (UFMG); Pediatra e Neurologista Infantil pelo Hospital Infantil João Paulo II (FHEMIG).
          </p>
          <p>
          ...
          <p>
            Hoje, atuo como Neuropediatra no Hospital das Clínicas da UFMG e no Hospital Infantil Padre Anchieta. 
          </p>
          <p>
            Meus atendimentos são na clínica Alegrart. Será um prazer cuidar da sua criança!
          </p>
        </div>
      </div>
    </div>
